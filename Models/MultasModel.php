...
class MultasModel extends Query
{
    ...
    {
        $sql = "SELECT m.id AS id, e.matricula, e.nombre, l.clave, l.titulo, m.dias, m.c_multa, m.Estado, p.fecha_devolucion, m.fecha_create, m.recibe FROM multas m INNER JOIN prestamo p ON m.id_prestamo = p.id INNER JOIN 
